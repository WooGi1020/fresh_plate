...
const Section_first = () => {
  return (
    <div className="h-full px-4 sm:px-6 min-h-screen lg:px-8 md:min-h-screen md:max-h-screen flex items-center">
      <div className="w-full flex flex-col justify-center items-center text-center gap-6 sm:gap-8 lg:gap-10 py-10 md:py-0">
        ...
        <div className="px-2">
          <h3 className="font-normal text-base sm:text-lg lg:text-[28px] mb-2 sm:mb-3">
            &quot; 여러분의 건강과 입맛에 맞춘 식당을 찾아보세요. &quot;
          </h3>
          <h3 className="font-semibold text-base sm:text-lg lg:text-[28px]">
            지금, 여러분 주변에서 찾을 수 있어요.
          </h3>
        </div>
      </div>
    </div>
