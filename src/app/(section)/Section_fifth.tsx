...
const Section_fifth = () => {
  return (
    <div className="h-full md:min-h-screen md:max-h-screen flex items-center bg-[#CBD2A9] px-4 py-10">
      <div className="flex flex-col xl:flex-row justify-center items-center w-full max-w-[1500px] mx-auto gap-10">
        ...
        <div className="flex flex-col items-center gap-6 sm:gap-8 text-center px-2 w-full max-w-[624px]">
          ...
          <Link
            href="/search"
            className="w-full h-[64px] sm:h-[80px] md:h-[98px] flex justify-center items-center bg-[#EAEEDB] rounded-md border-2 border-[#504840]"
          >
